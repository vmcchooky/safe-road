...
func TestLoadRuntimeSecurityProductionRequiresSecrets(t *testing.T) {
	...
	t.Setenv("SAFE_ROAD_ADMIN_API_KEY", "")
	t.Setenv("SAFE_ROAD_ADMIN_API_KEY_FILE", "")

	_, err := loadRuntimeSecurity()
	if err == nil || !strings.Contains(err.Error(), "SAFE_ROAD_ADMIN_PASSWORD") {
...
func TestLoadRuntimeSecurityProductionRejectsWeakSecrets(t *testing.T) {
	t.Setenv("SAFE_ROAD_ENV", "production")
	t.Setenv("SAFE_ROAD_ADMIN_PASSWORD", "change-me")
	t.Setenv("SAFE_ROAD_ADMIN_PASSWORD_FILE", "")
	t.Setenv("SAFE_ROAD_ADMIN_API_KEY", "short")
	t.Setenv("SAFE_ROAD_ADMIN_API_KEY_FILE", "")
...
func TestLoadRuntimeSecurityProductionAcceptsFileSecrets(t *testing.T) {
	...
	t.Setenv("SAFE_ROAD_ENV", "production")
	t.Setenv("SAFE_ROAD_ADMIN_PASSWORD", "")
	t.Setenv("SAFE_ROAD_ADMIN_PASSWORD_FILE", passwordFile)
	t.Setenv("SAFE_ROAD_ADMIN_API_KEY", "")
	t.Setenv("SAFE_ROAD_ADMIN_API_KEY_FILE", apiKeyFile)

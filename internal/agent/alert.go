...
func (t *AlertTask) Run(ctx context.Context) error {
	...
	payload := AlertPayload{
		...
		EventType: "safe_road_agent_alert",
		Summary:   "Safe Road: " + strings.Join(summaryParts, ", "),
		Events:    alertEvents,
	}
...
func (t *AlertTask) sendTelegram(ctx context.Context, criticalEvents []SpoofResult) error {
	...
	msg.WriteString("---------------------------------------------\n")
	msg.WriteString("🔒 <i>Safe Road - Bảo vệ người dân Việt Nam trước lừa đảo công nghệ cao.</i>")
...
func (t *AlertTask) sendSlack(ctx context.Context, criticalEvents []SpoofResult) error {
	...
	msg.WriteString("=============================================\n")
	msg.WriteString("_🔒 Safe Road - Bảo vệ người dân Việt Nam trước lừa đảo công nghệ cao._")
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Hệ thống Safe Road đã phát hiện website giả mạo các cơ quan tổ chức hoặc ngân hàng tại Việt Nam và thực hiện tự động chặn đứng (auto-block):</p>`)
	...
	htmlBody.WriteString(`
        ...
        <div class="footer">
            🔒 Safe Road - Đồng hành cùng nhân dân Việt Nam chống tội phạm công nghệ cao.
        </div>
    </div>
</body>
</html>`)

...
Protect Safe Road services (core-api, dns-resolver) against abuse, DDoS, and resource exhaustion from a single source. Must work on a single budget VPS ($0/mo external cost) without external dependencies.

...
- Safe Road targets a single VPS. No need for distributed coordination.
...
|---|---|---|
| `SAFE_ROAD_RATELIMIT_ENABLED` | `true` | Enable/disable rate limiting |
| `SAFE_ROAD_RATELIMIT_ANALYZE_RPM` | `10` | /v1/analyze requests per minute |
| `SAFE_ROAD_RATELIMIT_ANALYZE_BURST` | `5` | /v1/analyze max burst |
| `SAFE_ROAD_RATELIMIT_DOH_RPM` | `100` | /dns-query requests per minute |
| `SAFE_ROAD_RATELIMIT_DOH_BURST` | `20` | /dns-query max burst |
| `SAFE_ROAD_RATELIMIT_DEFAULT_RPM` | `60` | Default requests per minute |
| `SAFE_ROAD_RATELIMIT_DEFAULT_BURST` | `15` | Default max burst |

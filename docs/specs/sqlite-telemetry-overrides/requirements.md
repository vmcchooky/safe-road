...
Add persistent local storage (SQLite) to Safe Road for two purposes:
...
- Configuration via two new environment variables (`SAFE_ROAD_SQLITE_PATH`, `SAFE_ROAD_TELEMETRY_RETENTION_DAYS`).

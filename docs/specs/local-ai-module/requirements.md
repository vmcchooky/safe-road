...
Add an optional local AI module powered by Gemini 2.5 Flash Lite so Safe Road can refine ambiguous risk decisions without introducing paid APIs or breaking the current fail-open behavior.

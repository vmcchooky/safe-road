...
Safe Road keeps `/metrics` as JSON for the single-VPS MVP. The baseline alert rules live in `ops/alerts/safe-road-alert-rules.yaml`.
...
- `SAFE_ROAD_DOCKER_LOG_MAX_SIZE`
- `SAFE_ROAD_DOCKER_LOG_MAX_FILE`

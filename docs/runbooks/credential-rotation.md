...
- `SAFE_ROAD_GEMINI_API_KEY`
- `SAFE_ROAD_DUCKDNS_TOKEN`
- `SAFE_ROAD_AGENT_WEBHOOK_URL`
- `SAFE_ROAD_ALERT_TELEGRAM_TOKEN`
- `SAFE_ROAD_ALERT_SLACK_WEBHOOK_URL`
- `SAFE_ROAD_ALERT_EMAIL_PASSWORD`
...
- DuckDNS token: run `scripts/safe-road.sh duckdns`.

...
Safe Road keeps deterministic analysis available when optional dependencies degrade. Redis cache loss, AI provider loss, or TLS/WHOIS enrichment failure must not turn into a blanket outage for the analyzer or resolver.

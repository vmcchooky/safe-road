# Ước tính Chi phí Vận hành (OPEX) — Safe Road Anti-Phishing System
...
> **Khuyến nghị:** Với Safe Road v1.0 (single-node), **Hetzner CPX21 ($8.20/tháng)** là lựa chọn tối ưu nhất. Nếu cần hỗ trợ tại Đông Nam Á, chọn **Vultr Singapore** ($24/tháng).
...
> Bắt đầu bằng **Kịch bản B (Hetzner $10/tháng)** hoặc **Kịch bản C (Vultr $28/tháng)**. Safe Road v1.0 hoàn toàn có thể chạy mượt trên 1 VPS 2vCPU/4GB vì:
